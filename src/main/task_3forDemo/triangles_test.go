...
func TestTrianglesSquareSort(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name: "error, 3 triangles, names of vertices dont fit values",
		...
		{
			name: "no error, 5 triangles,4 of them have same names",
			input: []Triangle{{"ABC", 10.0, 20.0, 22.36, 0},
				{"CBA", 16.0, 15.0, 6, 0},
				{"CBA", 16.0, 15.0, 6, 0},
				{"CBA", 16.0, 15.0, 6, 0},
				{"CBA", 16.0, 15.0, 6, 0}},
			expVerticesNames: []string{"CBA","CBA","CBA","CBA", "ABC"},
			needError: false,
		},
		{
			...
			input: []Triangle{{"ABC", 10, 20, 22.36, 0},
				{"CBA", 16, 15, 6, 0}},
			expVerticesNames: []string{"CBA", "ABC"},
			needError:        false,
		},
		{
